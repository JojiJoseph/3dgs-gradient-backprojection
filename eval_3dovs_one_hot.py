# This script is used for evaluating 3DOVS one hot
...
class Args:
    ...
    feature_path: str = "./results/3DOVS_feats/bed/features_one_hot_3dovs_bed.pt"
    ...
    for image in splats["colmap_project"].images.values():
        ...
        if image_stem == last_dir or flag:
            ...
            for idx, class_ in enumerate(classes):
                mask3d = features.argmax(dim=1) == idx
